...
public abstract class GenericServlet implements Servlet, ServletConfig,
    ...
    public jakarta.servlet.ServletConfig getServletConfig() {
        return new ServletConfigReverseAdapter(config);
    }

    @Override
    public ServletConfig getJavaxServletConfig() {
        return config;
    }
    ...
    public ServletContext getServletContext() {
        return new ServletContextAdapter(getServletConfig().getServletContext());
    }
