 ...
 */
public interface Servlet extends jakarta.servlet.Servlet {
     ...
     */
    public default void init(ServletConfig config) throws ServletException
    {
    }

    public default void init(jakarta.servlet.ServletConfig config) throws jakarta.servlet.ServletException
    {
        try
        {
    ...
    default javax.servlet.ServletConfig getJavaxServletConfig()
    {
        return new ServletConfigAdapter(getServletConfig());
    }
