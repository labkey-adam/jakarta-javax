...
{
    private final jakarta.servlet.ServletContext _servletContext;
    ...
    {
        return new ServletContextAdapter(_servletContext.getContext(s));
    }
    ...
    {
        return new RequestDispatcherAdapter(_servletContext.getRequestDispatcher(s));
    }

    @Override
    public RequestDispatcher getNamedDispatcher(String s)
    {
        return new RequestDispatcherAdapter(_servletContext.getNamedDispatcher(s));
    }
...
//        return _servletContext.createListener(aClass);
    ...
    {
        throw new NotYetImplementedException();
        // _servletContext.getJspConfigDescriptor();
    }
